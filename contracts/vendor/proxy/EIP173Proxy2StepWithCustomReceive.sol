...
import {EIP173ProxyWithCustomReceive} from "./EIP173ProxyWithCustomReceive.sol";

/**
 * @notice EIP173ProxyWithCustomReceive with a transfer and accept ownership transfer process.
 *
 * @dev stores pendingOwner in keccak256('EIP173Proxy2Step.pendingOwner')
 */
contract EIP173Proxy2StepWithCustomReceive is EIP173ProxyWithCustomReceive {
    ...
    constructor(
        ...
        payable
        EIP173ProxyWithCustomReceive(implementationAddress, ownerAddress, data)
    {}
